        ...
        <div className="space-y-12">
          <section>
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-clouddrove-light/30">
              ...
              <pre className="bg-clouddrove-light/10 rounded-lg p-4 overflow-x-auto text-sm mb-6">
{`{
...
{`{
  ...
  "url": "string"
          ...
          <section>
            <h2 className="text-3xl font-bold text-clouddrove-dark mb-4">Examples</h2>
            <div className="bg-white rounded-2xl p-8 border-2 border-clouddrove-light/30">
...
print(data['url'])  # Share this one-time link`}
          ...
          <section>
            <h2 className="text-3xl font-bold text-clouddrove-dark mb-4">Self-Hosting</h2>
