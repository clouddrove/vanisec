...
// Redeems a pairing code: the short code shown after creating a password
// protected secret, so it can be opened on a second device without typing a
// UUID by hand.
//
// This is not the way to move text between your own devices. That is the
// clipboard, which needs no password at all. What survives here is the case the
// clipboard deliberately does not cover: a one-time secret that a password
// still guards.
...
export default function RedeemForm() {
  ...
  return (
    <form
      ...
      className="bg-white/70 backdrop-blur-sm border-2 border-clouddrove-light/30 rounded-2xl p-6 md:p-8 shadow-lg space-y-5"
    >
      <div>
      ...
      <p className="text-xs text-clouddrove-light/80 text-center">
        Codes work once and expire after five minutes. You will still need the password.{' '}
        <a href="/clipboard" className="underline underline-offset-2 hover:text-clouddrove-dark">
